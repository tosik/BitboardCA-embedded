...
NeumannOuterTotalisticCA::NeumannOuterTotalisticCA(unsigned int size_x, unsigned int size_y)
...
Bitboard NeumannOuterTotalisticCA::StepByOuterTotalistic(Bitboard board,
