...
NeumannOuterTotalisticCA::NeumannOuterTotalisticCA(unsigned int size_x,
                                                   unsigned int size_y)
    : LargeBitboard(size_x, size_y) {}

NeumannOuterTotalisticCA::~NeumannOuterTotalisticCA() {}

void NeumannOuterTotalisticCA::Step() {
...
Bitboard NeumannOuterTotalisticCA::StepByOuterTotalistic(
